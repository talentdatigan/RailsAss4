...
ActiveRecord::Schema.define(version: 2019_11_16_121839) do
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.integer "credit_cards_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["addresses_id"], name: "index_profiles_on_addresses_id"
    t.index ["credit_cards_id"], name: "index_profiles_on_credit_cards_id"
  end
